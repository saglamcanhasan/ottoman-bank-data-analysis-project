...
create_figure_callback(lambda **kwargs: request("employee-tenure", **kwargs), lambda df: graph(box(df, "Agency", "Tenure", "Agency", "Employee Tenure Distribution by Agency", "Agencies", "Tenure")), "employee-tenure", True, True, True, False, True, filter_id="employee-tenure")

create_figure_callback(lambda **kwargs: request("size-vs-tenure", **kwargs), lambda df: graph(scatter(df,  "Average Tenure", "Average Employee Count", "Average Agency Size vs. Average Employee Tenure", "Average Tenure", "Average Employee Count", ["Agency", "Min Employee Count", "Max Employee Count", "Min Tenure", "Max Tenure"], True)), "size-vs-tenure", True, True, True, False, True, filter_id="size-vs-tenure")